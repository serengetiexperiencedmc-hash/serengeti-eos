...
export function addManifestEntry(
  ...
  const entry: OpsManifestEntry = {
    ...
    ...(input.rooming !== undefined ? { rooming: input.rooming } : {}),
    ...(input.dietary !== undefined ? { dietary: input.dietary } : {}),
    ...(input.mobility !== undefined ? { mobility: input.mobility } : {}),
    ...(input.flightReference !== undefined ? { flightReference: input.flightReference } : {}),
    sortOrder,
    createdAt: now,
    updatedAt: now,
  };
