...
> **CURRENT STATE (2026-08-26 successor: ITE1 Dev/Test commit authorized — this file remains the 2026-08-25 name-only selection)**  
> **PRODUCT_STATE=FROZEN_DEVTEST** · last committed implementation HEAD=`fdf2436b1655fbe70a18117e64f54cc101cb71ae` (P2).  
> The historical body below is the **name-only selection**. It is **not** rewritten.  
> **Successor:** ID assignment, Stage 1 authoring, Stage 1 approval, Dev/Test implementation, Dev/Test Preview **PASS**, human signed-in UI **PASS**, and Development/Test **commit authorization** are recorded in [`ite1-endpoint-register-authorized.md`](ite1-endpoint-register-authorized.md) and [`../architecture/ite1-endpoint-register-preview.md`](../architecture/ite1-endpoint-register-preview.md).  
> **CAPABILITY=ENDPOINT_REGISTER** · **SELECTION_STATUS=SELECTED** (unchanged) · **CAPABILITY_ID=ITE1** (assigned at Stage 1 authoring, not by this historical record) · **STAGE_1_CREATED=YES** · **STAGE_1_STATUS=APPROVED** · **STAGE_1_APPROVED=YES** · **PATH_B_ENDPOINT_STAGE_1=APPROVED** · **ITE1_IMPLEMENTATION_AUTHORIZED=YES** · **ITE1_IMPLEMENTATION_ENVIRONMENT=DEV_TEST_ONLY** · **ITE1_PREVIEW_AUTHORIZATION=YES** · **PREVIEW_RESULT=PASS** · **HUMAN_ACCEPTANCE=PASS** · **COMMIT=AUTHORIZED** · **PATH_B_GENERAL_AUTO_SELECTION=PAUSED** · **UAT=NOT_AUTHORIZED** · **PRODUCTION=NOT_AUTHORIZED** · **PUSH=NOT_AUTHORIZED** · **ADR-0006=OPEN**  
>
